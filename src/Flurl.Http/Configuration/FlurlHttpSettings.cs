...
namespace Flurl.Http.Configuration
{
    ...
    public class FlurlHttpSettings
    {
        ...
        protected T Get<T>([CallerMemberName] string propertyName = null) {
            ...
            return testVals?.ContainsKey(propertyName) == true ? (T) testVals[propertyName] :
                _vals.ContainsKey(propertyName) ? (T) _vals[propertyName] :
                Defaults != null ? (T) Defaults.Get<T>(propertyName) : default(T);
        }
